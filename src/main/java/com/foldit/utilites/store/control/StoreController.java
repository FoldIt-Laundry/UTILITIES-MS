...
public class StoreController {
    ...
    public ResponseEntity<NearestStoreAvailableRespone> getNearestAvailableStoreDetails(@RequestBody NearestStoreAvailableRequest nearestStoreAvailableRequest, @RequestParam String authToken) {
