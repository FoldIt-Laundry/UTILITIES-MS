...
public class StoreController {
    ...
    public ResponseEntity<NearestStoreAvailableRespone> getNearestAvailableStoreDetails(@RequestBody NearestStoreAvailableRequest nearestStoreAvailableRequest, @RequestBody String authToken) {
